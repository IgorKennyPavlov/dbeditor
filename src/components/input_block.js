            ...
            case "category":
                inputFields =
                    <div className="input_panel-wrap">
                        <label className="key_container"><span className="key">title</span><input type="text" className="category_input" placeholder="название категории" /></label>
                        <label className="key_container"><span className="key">cardh1title</span><input type="text" className="category_input" placeholder="название товара (ед.ч.)" /></label>
                        <label className="key_container"><span className="key">link</span><input type="text" className="category_input" placeholder="ссылка на страницу категории" /></label>
                        <label className="key_container"><span className="key">priceList</span><input type="text" className="category_input" placeholder="ссылка на прайс-лист" /></label>
                    </div>;
                break;
                case "subcat":
                inputFields =
                ...
                inputFields =
                    <div className="input_panel-wrap">
                        <label className="key_container"><span className="key">title</span><input type="text" className="card_input" placeholder="название товара" /></label>
                        <label className="key_container"><span className="key">article</span><input type="text" className="card_input" placeholder="артикул" /></label>
                        ...
                        <label className="key_container"><span className="key">link</span><input type="text" className="card_input" placeholder="ссылка на страницу товара" /></label>
                        <label className="key_container"><span className="key">prodClass</span><input type="text" className="card_input" placeholder="rec|new|hit|sale|disc" /></label>
                        <div className="key_container input_panel-subsection col attributes">
                        ...
                        <label className="key_container"><span className="key">images</span><textarea className="card_input" placeholder="ссылки на изображения (массив)" /></label>
                        <div className="key_container input_panel-subsection col">
                        ...
                        <div className="infoBlock" data-folder="infoBlock">
                            ...
                            <label className="key_container"><span className="key">desc</span><textarea className="card_input" placeholder="описание для инфоблока" /></label>
                            <label className="key_container"><span className="key">advantages</span><textarea className="card_input" placeholder="описание преимуществ товара для инфоблока (массив)" /></label>
                            <label className="key_container"><span className="key">appAreas</span><textarea className="card_input" placeholder="описание областей применения для инфоблока" /></label>
                        </div>
                    </div>;
                break;
            default:
